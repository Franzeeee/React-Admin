    ...
    <div className={`card ${styles.card}`}>
        ...
        <div className={`card-body`}>
            <div className={`${styles['album-details']}`}>
                <img src={albumDetails.albumCover} />
                <div className={`${styles['details-text']}`}>
                    <h6>Title:<span>{albumDetails.albumTitle}</span></h6>
                    <p>Description (Optional): <span>{albumDetails.albumDescription}</span></p>
                </div>
            </div>
                ...
                <div className={`${styles.music}`}>
                    <table>
                        ...
                        <tbody>
                            ...
                            {musicData && musicData.map((musicItem, index) => (
            ...
            <button id='submitAlbum' className={`${styles.submit}`} type='submit'>Submit</button>
        </div>
    </div>
  )
}
